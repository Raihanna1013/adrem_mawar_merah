...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="<?php echo site_url('admin/tentang/updatelogo/' . $logo->id_logo); ?>" 
      method="POST" enctype="multipart/form-data">

    <div class="form-group">
        <label for="gambar_logo">Foto Logo</label>
        <input type="file" id="gambar_logo" name="gambar_logo"> <br>
        <small>Foto Saat Ini:</small>
        <img src="<?php echo base_url('asset/img/' . $logo->gambar_logo); ?>" width="100">
    </div>
