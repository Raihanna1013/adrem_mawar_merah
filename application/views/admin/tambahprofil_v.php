...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="<?php echo site_url('Admin/tentang/tambah_profilaction'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="subjudul_profil" name="subjudul_profil">
            </div>

            <div class="form-group">
                <label for="deskripsi_profil">Deskripsi</label>
                <input type="text" class="form-control" id="deskripsi_profil" name="deskripsi_profil"  required>
            </div>
