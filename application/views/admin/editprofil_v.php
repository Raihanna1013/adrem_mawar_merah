...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="<?php echo site_url('Admin/Tentang/updateprofil/' . $profil->id_profil); ?>" method="POST" enctype="multipart/form-data">

            <div class="form-group">
            <label for="judul_profil">Nama Barang</label>
            <input type="text" id="judul_profil" name="judul_profil" class="form-control" value="<?php echo $profil->judul_profil; ?>"> <br>
            </div>

            <div class="form-group">
            <label for="subjudul_profil">Sub Judul</label>
            <input type="text" id="subjudul_profil" name="subjudul_profil" class="form-control" value="<?php echo $profil->subjudul_profil; ?>">
            ...
            <textarea id="deskripsi_profil" name="deskripsi_profil" class="form-control" rows="4" required><?php echo $profil->deskripsi_profil; ?></textarea> <br>
            </div>
