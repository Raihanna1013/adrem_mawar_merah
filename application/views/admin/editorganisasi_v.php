...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="<?php echo site_url('Admin/Tentang/Updateorganisasi/' . $organisasi->id_organisasi); ?>" method="POST" enctype="multipart/form-data">

            <div class="form-group">
            <label for="judul_organisasi">Judul Organisasi</label>
            <input type="text" id="judul_organisasi" name="judul_organisasi" class="form-control" value="<?php echo $organisasi->judul_organisasi; ?>"> <br>
            </div>

            <div class="form-group">
            <label for="subjudul_organisasi">Sub Judul</label>
            <input type="text" id="subjudul_organisasi" name="subjudul_organisasi" class="form-control" value="<?php echo $organisasi->subjudul_organisasi; ?>">

            </div>

            <div class="form-group">
            <label for="gambar_organisasi">Foto Dokumentasi</label>
                <input type="file" id="gambar_organisasi" name="gambar_organisasi"> <br>
                <small>Foto Saat Ini:</small>
                <img src="<?php echo base_url('asset/img/' . $organisasi->gambar_organisasi); ?>" width="100">
            </div>

            <div class="form-group">
            <label for="deskripsi_organisasi">Deskripsi Profil</label>
            <textarea id="deskripsi_organisasi" name="deskripsi_organisasi" class="form-control" rows="4" required><?php echo $organisasi->deskripsi_organisasi; ?></textarea> <br>
            </div>
