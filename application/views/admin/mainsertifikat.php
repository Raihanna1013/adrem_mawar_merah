...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="<?php echo site_url('Admin/Tentang/Tambah_sertifikat'); ?>" class="btn btn-primary mb-3">Tambah Sertifikat</a>
...
<table class="table table-striped table-bordered">
    <thead>
        <tr>
            ...
            <th>Gambar Sertifikat</th> <!-- Perbaiki penutupan th -->
            <th>Aksi</th>
        </tr>
    </thead>
    <tbody>
        <?php if (!empty($sertifikat)) : ?>
            <?php foreach ($sertifikat as $stf): ?>
                <tr>
                    <!-- Tambahkan sub judul -->
                    <td><?php echo $stf['deskripsi_sertifikat']; ?></td>
                    <td>
                        <img src="<?php echo base_url('/asset/img/' . $stf['gambar_sertifikat']); ?>" 
                             alt="Foto Dokumentasi" 
                             style="width: 100px; height: 100px; object-fit: cover;">
                    </td>
                    <td>
                    <a href="<?php echo site_url('Admin/Tentang/editsertifikat/'.$stf['id_sertifikat']);?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="<?php echo site_url('Admin/Tentang/hapus_sertifikat/'.$stf['id_sertifikat']);?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk ini?');">Hapus</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
