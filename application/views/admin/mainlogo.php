...
<body>
    ...
    <div class="container mt-5">
        ...
        <a href="<?php echo site_url('Admin/Tentang/tambah_logo'); ?>" class="btn btn-primary mb-3">Tambah Informasi</a>

    <!-- Tabel Produk dengan Bootstrap -->
<table class="table table-striped table-bordered">
    <thead>
        <tr>
            <th>Gambar Logo</th> <!-- Perbaiki penutupan th -->
            <th>Aksi</th>
        </tr>
    </thead>
    <tbody>
        <?php if (!empty($logo)) : ?>
            <?php foreach ($logo as $lg): ?>
                <tr>
                    <td>
                        <img src="<?php echo base_url('/asset/img/' . $lg['gambar_logo']); ?>" 
                             alt="Foto Dokumentasi" 
                             style="width: 100px; height: 100px; object-fit: cover;">
                    </td>
                    <td>
                    <a href="<?php echo site_url('Admin/Tentang/editlogo/'.$lg['id_logo']);?>" class="btn btn-warning btn-sm">Edit</a>
                        <a href="<?php echo site_url('Admin/Tentang/hapus_logo/'.$lg['id_logo']);?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus produk ini?');">Hapus</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
