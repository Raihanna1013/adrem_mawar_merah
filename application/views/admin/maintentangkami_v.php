...
<body>
    ...
    <div class="container mt-5">
        <h2>Pengaturan Profil UMKM Mawar Merah</h2>

        <!-- Tombol Tambah Produk -->
        <a href="<?php echo site_url('Admin/Tentang/profil_usaha'); ?>" class="btn btn-primary mb-3">Informasi Profil</a>
        <a href="<?php echo site_url('Admin/Tentang/organisasi'); ?>" class="btn btn-primary mb-3">Informasi Organisasi</a>
        <a href="<?php echo site_url('Admin/Tentang/sertifikat'); ?>" class="btn btn-primary mb-3">Informasi Sertifikat</a>
        <a href="<?php echo site_url('Admin/Tentang/logo'); ?>" class="btn btn-primary mb-3">Logo Organisasi</a>
